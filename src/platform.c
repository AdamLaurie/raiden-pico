...
void platform_init(void) {
    ...
    config.hv_pin = 0;           // No default (GP6 used by clock generator)
    config.voltage_pin = 0;      // No default (GP7 reassigned to glitch output)
    config.armed_pin = PIN_ARMED; // Armed status pin (GP16)
